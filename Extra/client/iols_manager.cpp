...
std::vector<std::string> g_vars_to_monitor = {"LS1.state", "LS1.RNN800.state", "LS1.RNN600.state", "LS1.LSTAGE.state", "LS1.A1.state", "LS1.L1.state", "LS1.PM1.state", "LS1.PM1.energy_reading", "LS1.RNN800.current_position_motor", "LS1.RNN800.current_position_cib", "LS1.RNN600.current_position_motor", "LS1.RNN600.current_position_cib", "LS1.LSTAGE.current_position_motor", "LS1.LSTAGE.current_position_cib", "LS1.A1.position",
...
void update_right_pane(WINDOW *right_pane, std::atomic<bool> &running, int height, IoLSMonitor &monitor)
{
  ...
  while (running)
  {
    ...
    mvwprintw(right_pane, vpos, 2, "Laser status code : %02d \t\t\t Laser trigger count : %d",
              ...
              status.count("LS1.L1.shot_count_cib") ? std::get<uint32_t>(status["LS1.L1.shot_count_cib"]) : -1);
    ...
    vpos += 2;
    mvwprintw(right_pane, vpos, 2, "Power Meter :  energy   : %.3g J",
