...
void DIoLaserSystem::update()
{
	...
	std::vector<DIoLLaserUnit* > m_IoLLaserUnits;
    std::vector<DIoLMotor* > m_IoLMotors;
    std::vector<DIoLPiezoController* > m_IoLPiezoControllers;
    std::vector<DIoLAttenuator* > m_IoLAttenuators;
